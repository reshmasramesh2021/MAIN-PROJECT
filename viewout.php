                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table class="table table-dark">
                                    ...
                                    <?php 
		require('../db/db.php');
//taking teacher details data from database
        $query = "SELECT * FROM `tout` ORDER BY `toid`";
		$result = mysqli_query($con,$query) or die(mysqli_error($con));
		$c=1;
		while($obj=mysqli_fetch_object($result))
		{	
			
			$tyre=mysqli_query($con,"SELECT `cname` FROM `customer` WHERE `cid`= '$obj->cuname'") or die(mysqli_error($con));
			$tyre1=mysqli_fetch_object($tyre);
			$tyr=mysqli_query($con,"SELECT `tbrand` FROM `tyre` WHERE `tid`= '$obj->trbrand'") or die(mysqli_error($con));
			$tyr1=mysqli_fetch_object($tyr);
			$str=mysqli_query($con,"SELECT `stock` FROM `tyre` WHERE `tid`= '$obj->tstock'") or die(mysqli_error($con));
			$str1=mysqli_fetch_object($str);
                    echo"
					    <tr><td>$c</td>
                        <td>$tyre1->cname</td>
                        <td>$tyr1->tbrand</td>
                        ...
                        <td>$obj->tax1</td>
						<td>$obj->bno</td>
					   <td><a href=\"invoice-form1.php\"><button type=\"button\" class=\"btn btn-info\">PRINT</button></a></td>
                      </tr>";	
					  $c++;
		}
?>
