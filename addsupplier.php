<?php require('wmanager_session.php');
 require('../db/db.php');
     //session_start();
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
	{
        ...
        $query = "INSERT INTO `supplier` (`ssid` ,`sname`,`contno`,`addr`) VALUES (NULL,'$sname','$contno','$addr' )";
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-id-badge"></i><a href="addsupplier.php">Add Suppliers</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-puzzle-piece"></i><a href="tin.php">Transaction In</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="tout.php">Transaction Out</a></li>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <strong>ADD</strong>  <strong>SUPPLIERS</strong>  
                                                    </div>
                                                    <div class="card-body card-block">
                                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                       
                                                        <div class="row form-group">
                                                                <div class="col col-md-3"> <label class="form-control-label" for="text-input">Company Name</label></div>
                                                                <div class="col-12 col-md-9"><input type="text" id="sname" name="sname" placeholder="" class="form-control"></div>
                                                            </div>
                                                            
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Contact No</label></div>
                                                                <div class="col-12 col-md-9"><input type="tel" id="contno" name="contno" placeholder="" class="form-control">
                                                                <span id="messages1"> </span></div>
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Address</label></div>
                                                                <div class="col-12 col-md-9"><input type="text" id="addr" name="addr" placeholder="" class="form-control"> <span id="result"> </span></div>
                                                            </div>
