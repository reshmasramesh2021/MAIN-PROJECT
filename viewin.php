                    ...
                    <div class="col-lg-15">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">TRANSACTION IN</strong>
                            </div>
                            <div class="card-body">
...
//taking teacher details data from database
        $query = "SELECT * FROM `transactionin` ORDER BY `trid`";
		$result = mysqli_query($con,$query) or die(mysqli_error($con));
		$c=1;
		while($obj=mysqli_fetch_object($result))
		{	
			
			$tyre=mysqli_query($con,"SELECT * FROM `supplier` WHERE `ssid`= '$obj->name'") or die(mysqli_error($con));
			$tyre1=mysqli_fetch_object($tyre);
			$tyr=mysqli_query($con,"SELECT * FROM `tyre` WHERE `tid`= '$obj->trbrand'") or die(mysqli_error($con));
			...
			$str1=mysqli_fetch_object($str);
                    echo"
                        ...
                        <td>$obj->tax</td>
					   <td><a href=\"print.php?ssid=$tyre1->ssid&tid=$tyr1->tid\"><button type=\"button\" class=\"btn btn-info\">PRINT</button></a></td>
                      </tr>";	
					  $c++;
		}
?>
