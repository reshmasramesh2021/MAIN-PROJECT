        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                                            ...
                                            <div class="col-lg-6">
                                             ...
                                             <label class="control-label " for="type">FROM </label>
                                             <input class="control-label" id="date" name="date" placeholder="DD/MM/YYYY" type="date" required />
                                             <label class="control-label " for="type">TO </label>
                                             <input class="control-label" id="date" name="date" placeholder="DD/MM/YYYY" type="date" required />
                                             <br><br>
                                             <center><input type="submit" value="Search" name="submit">
                                               </div>
</form>
<table border=1>
                    <tr>
    ...
    {
        $date= $_POST["date"];
        $query = "select * from `transactionin` where date ='".$date."'";
